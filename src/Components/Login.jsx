  ...
  return (
    <>
      <div className="login-page  w-screen h-screen relative  flex flex-col 2xl:flex-row lg:flex-row 2xl:overflow-hidden lg:overflow-hidden">
        ...
        <div className="loginImage  relative flex-1 w-full 2xl:h-full lg:h-full  md:flex md:justify-center md:items-center
...
{
  /* <div className="overlay hidden 2xl:block  h-full w-full inset-0 absolute   2xl:bg-black 2xl:opacity-50 z-10"> </div>*/
}
